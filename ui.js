        ...
        this.profile.innerHTML = `
            <div class="card card-body mb-3">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <span class="badge badge-danger m-1">Public Respo: ${user.public_repos}</span>
                        <span class="badge badge-dark m-1">Followers: ${user.followers}</span>
                        <span class="badge badge-danger m-1">Following: ${user.following}</span>
                        <br><br>
                        <ul class="list-group">
